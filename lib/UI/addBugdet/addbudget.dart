...
class _AddBudgetState extends State<AddBudget> {
                                ...
                                TextButton(
                                  onPressed: () {
                                    ...
                                    Navigator.popUntil(
                                        context,
                                        (route) => route
                                            .isFirst); // Return to home screen
                                    // Show the snackbar on the home screen
                            ...
                            ElevatedButton.icon(
                              ...
                              label: Text(
                                isEdit
                                    ...
                                    : pickedDate ??
                                        'Select a date', // Use a fallback text if pickedDate is null
  ...
  findHeight() {
    ...
    childHeight = renderBox.size.height*1.25;
  }
}
